...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-muted/30 [&_tr]:border-b-2", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-14 px-4 text-left align-middle font-bold text-foreground/80 uppercase tracking-wider text-[11px] [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
