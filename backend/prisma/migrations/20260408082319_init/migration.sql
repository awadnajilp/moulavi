...
-- CreateEnum
CREATE TYPE "UmrahVisaStatus" AS ENUM ('pending', 'documents_downloaded', 'group_assigned', 'voucher', 'bill', 'booking_success', 'cancelled');
...
-- CreateEnum
CREATE TYPE "LocationType" AS ENUM ('HOTEL', 'AIRPORT', 'ZIYARAT', 'OTHERS');

-- CreateEnum
CREATE TYPE "PartyDocumentType" AS ENUM ('gst_certificate', 'pan_card', 'aadhaar_card', 'other');

-- CreateEnum
CREATE TYPE "RouteType" AS ENUM ('citytocity', 'airporttocity', 'citytoairport', 'tripandtour', 'fulltrip');
...
CREATE TABLE "umrah_visa_bookings" (
    ...
    "visa_type" "VisaType" NOT NULL DEFAULT 'individual_visa',
    "has_transportation" BOOLEAN NOT NULL DEFAULT false,
    "voucher_generated_at" TIMESTAMP(3),
    "voucher_generated_by" TEXT,
    "bill_generated_at" TIMESTAMP(3),
...
CREATE TABLE "cancellation_policies" (
    ...
    "refund_percentage" DECIMAL(65,30) NOT NULL,
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "umrah_movement_details" (
    "id" TEXT NOT NULL,
    "booking_id" TEXT NOT NULL,
    "travel_datetime" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "umrah_visa_masters" (
    "id" TEXT NOT NULL,
    "last_arrival_date" TIMESTAMP(3) NOT NULL,
    "last_departure_date" TIMESTAMP(3) NOT NULL,
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "umrah_travel_details" ADD CONSTRAINT "umrah_travel_details_arrival_airport_id_fkey" FOREIGN KEY ("arrival_airport_id") REFERENCES "location_masters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "umrah_travel_details" ADD CONSTRAINT "umrah_travel_details_departure_airport_id_fkey" FOREIGN KEY ("departure_airport_id") REFERENCES "location_masters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
